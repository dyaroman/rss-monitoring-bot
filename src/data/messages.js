...
Чтобы добавить твой первый мониторинг, пожалуйста пришли мне "/add" и следуй инструкции.
  `,
    ...
    removeMonitoringQuestion:
        'Чтобы удалить мониторинг, пожалуйста пришлите его номер или полный запрос:',
    confirmRemoveAllMonitorings:
        'Удалить все мониторинги? \nЭто действие необратимо!',
    ...
    searchResultTitle:
        '🎯 Мониторинг "<b>{{query}}</b>" дал следующие результаты:\n\n',
